...
Use this guide to run kube-memory on your machine. For the hosted product, open [https://kube-memory.buildlab.in/](https://kube-memory.buildlab.in/).
...
Restart your editor. See [usage.md](../usage.md) for the full setup journey and tool reference.
